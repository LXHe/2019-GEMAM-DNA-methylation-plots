# -*- coding: utf-8 -*-
"""
Created on Fri Oct 26 10:42:18 2018
...
4-p01_S_vs_N/sumdata/p01_S_vs_N_S.csv')

ir = pd.read_csv('C:/Users/u0105352/Desktop/Lingxiao/MOVEAGE2015/Initial_RawData/\
BC_corrected_methylation_beta/Sar_vs_N_Sar_ttest.csv')
#%%
...
# merge_cells to split multi-index into separated cells
#count_sig.to_excel(r'C:\Users\u0105352\Desktop\count.xlsx', merge_cells=False)
#%%
# Count by chromosome
...
#concate.to_excel(r'C:\Users\u0105352\Desktop\count.xlsx', merge_cells=False)
#%%
...
def cvt_sort(DataSet_all, DataSet_sig):
    ...
    count_test["CHR_all"].loc[count_test["CHR"]=="X"] = count_test.loc[count_test["CHR"]=="X"]["CHR_all"].values + count_test.loc[count_test["CHR"]=="Y"]["CHR_all"].values
